...
shell text only). Against a scripted mock brain the brain does exactly what the
script says, so an ordering assertion would be asserting the script rather than
holly. Proving holly actually sequences review before publication takes real
CLIs and real judgement — a live recipe, not a CI test.
