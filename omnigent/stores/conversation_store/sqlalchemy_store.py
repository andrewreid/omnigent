...
class SqlAlchemyConversationStore(ConversationStore):
    ...
    def list_conversations(
        ...
        # prefetch fallback.
        # shared_only is the one scope the EXISTS form cannot express: it is a set
        # difference (accessible minus owned), not a membership test, so it stays on
        # the prefetch path that computes that difference.
        acl_pushdown = needs_meta_filter and not shared_only and self._conv_engine is self._engine
